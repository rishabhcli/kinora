...
async def delete_book(book_id: str, container: ContainerDep, user: CurrentUser) -> None:
    """Remove a book from the shelf (e.g. a failed import the reader wants to retry)."""
