...
variable "oss_bucket_name" {
  type    = string
  default = "kinora-staging-assets"
}

variable "container_image" {
  type    = string
  default = "registry.ap-southeast-1.aliyuncs.com/kinora/backend:staging"
}

variable "frontend_container_image" {
  type    = string
  default = "registry.ap-southeast-1.aliyuncs.com/kinora/frontend:staging"
}
