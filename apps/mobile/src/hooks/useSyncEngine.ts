...
/** Per-session SyncEngine for mobile: binds into React, pushes intent/seek, and
 *  opens the live socket so clip_ready events hot-swap clips into the playhead. */
export function useSyncEngine(sessionId: string | null): {
  engine: SyncEngine;
